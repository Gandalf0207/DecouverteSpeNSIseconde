...
# Vous devez parcourir toute la chaine de caractère et comparé chaque caractère de cette chaine pour savoir si c'est une voyelle ou non
...
# Il vous suffiet d'ajouter de nouvelles vérification avec de nouvelles liste de valeurs et de nouveaux compteurs...
# ex : 
